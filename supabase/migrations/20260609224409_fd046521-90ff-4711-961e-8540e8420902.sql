...
-- Revoke execute from anon/public; only service_role (edge functions) should call these
...
-- redeem_coupon is SECURITY DEFINER and meant only for signed-in users
